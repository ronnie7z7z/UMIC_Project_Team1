...
if("TRUE" STREQUAL "TRUE")
  set(mybot_control_SOURCE_PREFIX /home/ronnie7z/mybot_ws/src/mybot_control)
  set(mybot_control_DEVEL_PREFIX /home/ronnie7z/mybot_ws/devel)
  ...
  set(mybot_control_INSTALL_PREFIX /home/ronnie7z/mybot_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mybot_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ronnie7z/mybot_ws/src/mybot_control/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT mybot_control_NUM_DUMMY_TARGETS)
      set(mybot_control_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::mybot_control::wrapped-linker-option${mybot_control_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR mybot_control_NUM_DUMMY_TARGETS "${mybot_control_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::mybot_control::wrapped-linker-option${mybot_control_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND mybot_control_LIBRARIES "${interface_target_name}")
